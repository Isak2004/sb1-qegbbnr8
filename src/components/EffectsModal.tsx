...
import { X, Snowflake, Heart, Flashlight, Circle, Shuffle, Sun, Camera } from 'lucide-react';

interface EffectsModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSelectEffect: (effect: 'snowflakes' | 'balloons' | 'spotlight' | 'bubbles' | 'scramble' | 'sunflare' | 'lensflare') => void;
}
